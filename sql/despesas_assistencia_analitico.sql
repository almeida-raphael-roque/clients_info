...
atualização feita por mim (wesley) na data do dia 06/02/24 para add a matricula na base */
select
*,
...
from (
    ...
    ROUND(cast(iap.assistance_total as DOUBLE), 2) as "valor_assis",
    ...
    and iab.benefit in ('ASSISTÊNCIA 24 HORAS')
    and iar.coverage <> 0
) as seg
------------------
UNION ALL
